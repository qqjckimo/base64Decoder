...
export class Sidebar {
  constructor() {
    ...
    this.translations = {
      'zh-TW': {
        ...
        icoAnalyzerName: 'ICO 檔案分析工具',
        jsonFormatterName: 'JSON 格式化工具',
        xmlFormatterName: 'XML 格式化工具',
        jsonToonConverterName: 'JSON to TOON 轉換器',
      ...
      en: {
        ...
        icoAnalyzerName: 'ICO File Analyzer',
        jsonFormatterName: 'JSON Formatter',
        xmlFormatterName: 'XML Formatter',
        jsonToonConverterName: 'JSON to TOON Converter',
  ...
  async loadToolsConfig() {
    ...
    this.tools = [
      ...
      {
        id: 'ico-analyzer',
        name: t.icoAnalyzerName,
        translationKey: 'icoAnalyzerName',
      ...
      },
      {
        ...
        name: t.jsonToonConverterName,
        translationKey: 'jsonToonConverterName',
        icon: createIcon('repeat', 20, 'tool-icon'),
        category: t.categoryTextProcessing,
      },
    ];
  }
